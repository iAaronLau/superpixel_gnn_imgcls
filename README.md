...
- `batch_train_imagewoof_resnet.conda.sh`
- `batch_train_imagewoof_gcn.conda.sh`
- `batch_train_imagewoof_gat.conda.sh`
- `batch_train_imagenette2_resnet.conda.sh`
- `batch_train_imagenette2_gcn.conda.sh`
- `batch_train_imagenette2_gat.conda.sh`
